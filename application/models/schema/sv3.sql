...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2021 at 10:58 AM
...
INSERT INTO `appointments` (`appt_id`, `title`, `schedule`, `schedule_id`, `service_id`, `reason`, `user_id`, `b_id`, `vet_id`, `pet_id`, `time`, `findings`, `date_created`, `status`, `color`) VALUES
...
(6, '', '0000-00-00', 6, 0, 'test', 32, 1, 2, 13, 'pm', '', '2021-05-30', 'pending', ''),
(7, '', '0000-00-00', 6, 0, 'test asdasdads', 32, 1, 2, 13, 'pm', 'asdasdasdasdadadasdasdasd', '2021-06-01', 'canceled', '');
